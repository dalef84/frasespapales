...
### REPO
set :repository, "git@github.com:dalef84/https://github.com/frasespapales.git"  # Your clone URL
set :scm, "git"
set :branch, "master"
...
role :web,      "ec2-user@ec2-54-232-196-174.sa-east-1.compute.amazonaws.com"
role :memcache, "ec2-user@ec2-54-232-196-174.sa-east-1.compute.amazonaws.com"
role :db,       "ec2-user@ec2-54-232-196-174.sa-east-1.compute.amazonaws.com", :primary => true
...
set :ec2onrails_config, {
  ...
  :restore_from_bucket => "frasespapales",
  ...
  # desired.
  # NOTE: this only applies if you are not using EBS
  :archive_to_bucket => "frasespapales",
 ...
 # :services_to_restart => %w(postfix sysklogd),
  ...
  # remove this.
  :mail_forward_address => "dalef2005@yahoo.com.ar",
...
set :rvm_install_pkgs, %w[iconv zlib libyaml openssl] # package list from https://rvm.io/packages
